...
namespace Microsoft.AspNetCore.Components.WebAssembly.Hosting
{
    ...
    public sealed class WebAssemblyHostBuilder
    {
        ...
        public WebAssemblyHost Build()
        {
            ...
            // We inject both the IConfiguration and WebAssemblyHostConfiguration
            // types so that users can access both the read-only and read/write types.
            Services.AddSingleton<IConfiguration>(Configuration);
            Services.AddSingleton<WebAssemblyHostConfiguration>(Configuration);
